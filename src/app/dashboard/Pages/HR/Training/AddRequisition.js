...
function AddProcRequisition() {
  ...
  const { beneficiaries, departments, isSubmitting } = useSelector(
    (x) => x?.procurement
  );
  const { vendorsTypes } = useSelector((state) => state?.global);
    ...
    location &&
      dispatch(
        GetVendors({
          ...
          currentPage: 1,
          sort: 1,
          VendorTypeId: location?.vendorType,
        })
      );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [location]);

  if (!asset_register || !beneficiaries || !Consummable_register) {
    return <p>Loading...</p>;
  }
        ...
        >
            ...
            <div className={DashboardStyle.inputs_group}>
              <div>
                <FormSelect
                  ...
                  array={
                    <>
                      <option value={0}>ICAN</option>
                      <option value={1}>GCert</option>
                    </>
                  }
                  moreRegister={{
                    onChange: (e) => {
          ...
          <div className={DashboardStyle.button_cage}>
            ...
            <ActionButtons
              ...
              disabled={
                !isValid || isSubmitting || vendorDocument?.length === 0
              }
              className={DashboardStyle?.button_cage_weight}
            >
              Submit
            ...
            moreRegister={{
              onChange: (e) => {
                ...
                return (
                  ...
                  setValue(`${fieldName}.branch`, isFound?.branchId)
                );
              },
            }}
          />
