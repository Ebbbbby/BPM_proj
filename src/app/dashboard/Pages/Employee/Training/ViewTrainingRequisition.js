...
import { CancelTrainingRequest, GetEmployeeTrainingRequisition } from "../../../../../utils/redux/HR/HRSlice";

function ViewEmployeeTrainingRequisition() {
      ...
      <PageActions>
          {[
...

            {
              ...
              action: () => {
                navigate(`../${id}/edit`, { state: requisition });
              },
...
export default ViewEmployeeTrainingRequisition;